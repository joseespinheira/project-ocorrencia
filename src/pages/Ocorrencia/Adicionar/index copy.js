...
const AdicionarOcorrencia = () => {
    ...
    const handleSalvar = (e) => {
        ...
        //falta as imagens
        var data = { ...localizacao, ...dadoEndereco, ...imagem, ...dadoOcorrencia, ...request }
        // var texto = JSON.stringify(imagem).split('{')[1].split('}')[0];

        // var result = JSON.stringify(data).split('}')[0];
        // result += ',';
        // result += texto;
        // result += '}';
        // data = JSON.parse(result);

        // console.log(imagem.anexo);return
        ...
        formData.append('issuings_id',data.issuings_id);
        formData.append('type_occurrences_id',data.type_occurrences_id);
        formData.append('status_occurrences_id',data.status_occurrences_id);
        formData.append('users_id',data.users_id);
        formData.append('clients_id',data.clients_id);
        formData.append('latitude',data.latitude);
        formData.append('longitude',data.longitude);
        formData.append('anexo[]',imagem.anexo);
